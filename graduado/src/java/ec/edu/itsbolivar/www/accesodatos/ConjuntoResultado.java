 ...
 */
package ec.edu.itsbolivar.www.accesodatos;
...
public class ConjuntoResultado {
    ...
    public String getString(int nCol) throws Exception {
        try {
            return this.Datos.get(indFil)[nCol - 1].toString();
        } catch (Exception e) {
            throw e;
        }
    ...
    public short getShort(int nCol) throws Exception {
        try {
            return new Short(this.Datos.get(indFil)[nCol - 1].toString());
        } catch (Exception e) {
            throw e;
        }
    }
    ...
    public byte[] getBytes(int nCol) throws Exception {
        try {
            return toBytes(this.Datos.get(indFil)[nCol - 1]);
        } catch (Exception e) {
            throw e;
        }
    }
    ...
    public int getInt(int nCol) throws Exception {
        try {
            int val = Integer.parseInt(this.Datos.get(indFil)[nCol - 1].toString());
            return val;
        } catch (Exception e) {
            throw e;
        }
    ...
    public double getDouble(int nCol) throws Exception {
        try {
            double val = Double.parseDouble(this.Datos.get(indFil)[nCol - 1].toString());
            return val;
        } catch (Exception e) {
            throw e;
        }
    ...
    public double getDouble(String nomCol) throws Exception {
        try {
            return Double.parseDouble(this.Datos.get(indFil)[Find(nomCol)].toString());
        } catch (Exception e) {
            throw e;
        }
    }
    ...
    public long getLong(int nCol) throws Exception {
        try {
            return (Long) (this.Datos.get(indFil)[nCol - 1]);
        } catch (Exception e) {
            throw e;
        }
    }
    ...
    public Date getDate(int nCol) throws Exception {
        try {
            return (Date) (this.Datos.get(indFil)[nCol - 1]);
        } catch (Exception e) {
            throw e;
        }
    }
    ...
    public java.sql.Timestamp getTimestamp(int nCol) throws Exception {
        try {
            return (java.sql.Timestamp) (this.Datos.get(indFil)[nCol - 1]);
        } catch (Exception e) {
            throw e;
        }
    }
    ...
    public boolean getBoolean(int nCol) throws Exception {
        try {
            return (Boolean) (this.Datos.get(indFil)[nCol - 1]);
        } catch (Exception e) {
            throw e;
        }
    }
    ...
    public Object getObject(int nCol) throws Exception {
        try {
            return this.Datos.get(indFil)[nCol - 1];
        } catch (Exception e) {
            throw e;
        }
