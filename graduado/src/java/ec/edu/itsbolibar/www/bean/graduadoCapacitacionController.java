...
@ManagedBean
@ViewScoped
public class graduadoCapacitacionController {
    ...
    public graduadoCapacitacionController() {
        try {
            cargarDatos();
        } catch (Exception ex) {
    ...
    public void insertar() throws Exception {
        ...
        Capacitacion c = FCapacitacion.insertarReturnId(item);
        item.setCodigo(c.getCodigo());
        Cursado cursado = new Cursado();
        cursado.setCapacitacion(item);
        cursado.setGraduado(graduado);
        FCursado.insertar(cursado);
        modal = true;
        cargarDatos();
    }
    ...
    public void eliminar(Capacitacion e) throws Exception {
        ...
        Cursado c = new Cursado();
        c.setCapacitacion(e);
        c.setGraduado(graduado);
        FCursado.eliminar(c);
    ...
    private void cargarDatos() throws Exception {
        ...
        lst_capacitacion = FCapacitacion.obtener(graduado);
